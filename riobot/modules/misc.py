...
from riobot import HELP, SUPPORT_GROUP
...
@riobot(pattern='^.chatid$', private=False)
def chatid(message):
...
def repo(message):
    edit(
        message,
        '[Rio Pyogram Repo](https://github.com/pyogram-userbot/' 'Pyogram-Userbot)',
        preview=False,
    )


@riobot(pattern='^.repeat')
...
@riobot(pattern='^.report$', compat=False, private=False)
