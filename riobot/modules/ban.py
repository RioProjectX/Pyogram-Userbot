...
@riobot(pattern='^.ban', private=False, admin=True)
...
@riobot(pattern='^.unban', private=False, admin=True)
...
@riobot(pattern='^.kick', private=False, admin=True)
...
@riobot(pattern='^.mute', private=False, admin=True)
...
@riobot(pattern='^.unmute', private=False, admin=True)
...
@riobot(pattern='^.promote', admin=True, private=False, compat=False)
...
@riobot(pattern='^.demote', private=False, admin=True)
...
@riobot(pattern='^.pin', private=False, admin=True)
...
@riobot(pattern='^.unpin', private=False, admin=True)
...
@riobot(pattern='^.(admins|bots|user(s|sdel))$', compat=False, private=False)
...
@riobot(pattern='^.zombies', private=False, compat=False)
...
@riobot(pattern='^.setgpic$', admin=True, private=False)
