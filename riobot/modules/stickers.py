...
from riobot import HELP, PACKNAME, PACKNICK, TEMP_SETTINGS
...
@riobot(pattern='^.(d[ıi]zla|kang)', compat=False)
...
@riobot(pattern='.packinfo$', compat=False)
