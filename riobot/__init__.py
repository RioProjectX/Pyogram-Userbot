...
import rionify.translator as _tr
...
RIO_LANG = environ.get('RIO_LANG', 'en')
...
# Riobot repo url for updater
REPO_URL = environ.get(
    'REPO_URL', 'https://github.com/RioProjectX/Pyogram-Userbot'
)
...
app = PyroClient('riobot', api_id=API_ID, api_hash=API_HASH, session_string=SESSION)
